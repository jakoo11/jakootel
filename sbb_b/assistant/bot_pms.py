...
async def bot_start(event):
    ...
    custompic = gvarstatus("BOT_START_PIC") or "https://telegra.ph/file/1860b3cdf99b31e50dab5.jpg"
    if chat.id != Config.OWNER_ID:
        ...
        buttons = [
            (
                Button.url("السورس", "https://t.me/mvhmed"),
                Button.url(
                    "المطور",
                    "https://t.me/mvhmed",
                ),
        ...
        buttons = [
            ...
            [
                ...
                Button.inline("• المطور •", data="https://t.me/mvhmed"),
            ],
        ]
    try:
        if custompic:
...
اوامر فارات سورس كرستين  @mvhmed""",
        buttons=[
