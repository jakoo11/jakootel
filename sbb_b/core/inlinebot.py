...
CATLOGO = "https://telegra.ph/file/1860b3cdf99b31e50dab5.jpg"
...
def main_menu():
    text = f"**▾∮ مرحبا عزيزي {mention}**\n**▾اليكَ قائمة بازرار مضمنة لاوامر ↫**⍣ⵧⵧⵧ𝙅𝘼𝙆𝙊𝙊ⵧⵧⵧⵧ⍣**\n[ََِِ𝙅𝘼𝙆𝙊𝙊 🧸♥](https://t.me/mvhmed)\n\n"
    buttons = [
...
async def inline_handler(event):
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if query.startswith("**sbb_b"):
            buttons = [
                (
                    ...
                    Button.url("DEV", "https://t.me/mvhmed"),
                )
            ]
            ...
            result = builder.article(
                title="sbb_b Help™",
                description="**▾∮ قائمة التعليمات الخاصة ب ببوت جاكو **",
                text=_result[0],
                buttons=_result[1],
                link_preview=False,
            )
        ...
        buttons = [
            (
                Button.url("قناة السورس", "t.me/mvhmed"),
                Button.url(
                    "المطور",
                    "t.me/mvhmed",
                ),
        ...
        text, msg_entities = await event.client._parse_message_text(
            "لجعل بوت جاكو من نصيبك!", "md"
        )
        result = types.InputBotInlineResult(
            id=str(uuid4()),
            type="photo",
            title="[𝙅𝘼𝙆𝙊𝙊](https://t.me/mvhmed)",
